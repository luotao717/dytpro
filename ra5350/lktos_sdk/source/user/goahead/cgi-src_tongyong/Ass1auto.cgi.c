int main (int argc, char *argv[])
{
	...
	printf("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n\
		...
		<title>Alat instal khusus pertama</title>\n\
		</head>\n");
...
<div class=\"logo-2\">Alat instal khusus pertama</div>\n\
<div class=\"logo-3\">Ringkas, hijau ,aman , efisien</div>\n\
<div class=\"logo-4\" id=\"logo-4\" onmousedown=\"s_bj()\"><a href='http://192.168.169.1/media/sda1/apk/firstteassitant.apk'>Klik download</a></div>\n\
<div class=\"logo-5\">Download alat instal khusus pertama untuk menawarkan akses internet gratis</div>\n\
